package com.db.grad.main.tokenauth.jwt;
...
public class JwtUtil {
    ...
    private String secret = "dbccdbccdbccdbccdbccdbccdbccdbccdbccdbccdbccdbccdbccdbccdbcc";
    private long timeToExpiry = 1000 * 60 * 60 * 24 * 5;
